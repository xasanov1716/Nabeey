...
import 'package:contest_app/utils/shimmers/home_shimmer.dart';
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              "Lorem Ipsum",
              style: TextStyle(
                  fontFamily: "Urbanist", fontSize: 24.sp, fontWeight: FontWeight.w700, color: AppColors.C_111111),
            ),
          ),
          body: ListView(
            children: [
                    ...
                    ...List.generate(
                      state.categories.length,
                        ...
                        onTap: () {
                          context
                              .read<CategoriesBloc>()
                              .add(SetCurrentCategory(categoryModel: state.categories[index]));
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    left: height * (16 / 812), top: height * (118 / 812), right: width * (16 / 375)),
                                child: Column(
